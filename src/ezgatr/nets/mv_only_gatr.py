...
from ezgatr.opt import (
    geometric_product_v0 as geometric_product_ver_0,
    equi_join_v0 as equi_join_ver_0,
    scaler_gated_gelu_ver_0,
    equi_geometric_attention_ver_0,

    geometric_product_v1 as geometric_product_ver_1,
    equi_join_v1 as equi_join_ver_1,
    scaler_gated_gelu_ver_1,
    equi_geometric_attention_ver_1,

    geometric_product_v2 as geometric_product_ver_2,
    equi_join_v2 as equi_join_ver_2,
    scaler_gated_gelu_ver_2,
    equi_geometric_attention_ver_2,

    # geometric_product_v3 as geometric_product_ver_3,
...
#             c=self.config.size_channels_hidden,
#         )
#         x, _ = equi_geometric_attention_ver_3(
#             q,
#             k,
#             v,
#             kinds=self.config.attn_kinds,
